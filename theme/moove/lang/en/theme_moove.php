...
$string['examorganizer'] = 'Exam Organizer';
$string['bookcourses'] = 'Book Courses';
...
// $string['dashboardbgimg'] = 'Dashboard page background';
// $string['dashboardbgimg_desc'] = 'Upload your custom background image for the Dashboard page.';
...
$string['howitworkloginlinkdesc'] = 'Add Login Link for How It Works';
$string['home24accessimage'] = 'Home 24 Access Image';
...
$string['bannerbuttonlink'] = 'Banner Button Link';
$string['bannerbuttonlinkdesc'] = 'Enter Banner Button Link';
