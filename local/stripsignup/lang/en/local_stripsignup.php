...
/**
 * Strings for component 'local_stripsignup', language 'en'.
 *
...
$string['stripesignupconfiguration'] = 'Stripe Payment';
$string['stripepayment_desc'] = 'Stripe Payment Settings';
$string['sandbox_stripesignupconfiguration'] = 'Sandbox Stripe Payment';
$string['sandbox_stripepayment_desc'] = 'Sandbox Stripe Payment Settings';
...
$string['sandboxlive'] = 'Enable Sandbox';
