...
/**
 * Class core_customfieldcategory_external
 *
 * @copyright 2018 David Matamoros <davidmc@moodle.com>
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class core_customfieldcategory_external extends external_api {
    ...
    public static function delete_field($id) {
        ...
        $record = \core_customfieldcategory\field_controller::create($params['id']);
    ...
    public static function reload_template($component, $area, $itemid) {
        ...
        $handler = \core_customfieldcategory\handler::get_handler($params['component'], $params['area'], $params['itemid']);
    ...
    public static function delete_category($id) {
        $category = core_customfieldcategory\category_controller::create($id);
    ...
    public static function move_field($id, $categoryid, $beforeid) {
        ...
        $field = \core_customfieldcategory\field_controller::create($params['id']);
