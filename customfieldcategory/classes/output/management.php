...
use core_customfieldcategory\handler;
use renderable;
use templatable;
...
class management implements renderable, templatable {
     ...
     *
     * @param \core_customfieldcategory\handler $handler
     */
    public function __construct(\core_customfieldcategory\handler $handler) {
    ...
    public function export_for_template(\renderer_base $output) {
        ...
        foreach ($categories as $category) {
            ...
            $categoryarray['movetitle'] = get_string('movecategory', 'core_customfieldcategory',
            ...
            foreach ($category->get_fields() as $field) {
                ...
                $fieldarray['movetitle'] = get_string('movefield', 'core_customfieldcategory', $fieldname);
            ...
            $menu->set_menu_trigger(get_string('createnewcustomfield', 'core_customfieldcategory'));
        ...
        if (empty($data->categories)) {
            $data->nocategories = get_string('nocategories', 'core_customfieldcategory');
        }
