...
/**
 *  core_customfieldcategory field value renderable.
 *
...
use core_customfieldcategory\data_controller;

defined('MOODLE_INTERNAL') || die;

/**
 * core_customfieldcategory field value renderable class.
 *
 * @package   core_customfieldcategory
 * @copyright 2018 Daniel Neis Araujo <danielneis@gmail.com>
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
...
class field_data implements \renderable, \templatable {
    ...
    /** @var \core_customfieldcategory\data_controller */
    protected $data;

    /**
     * Renderable constructor.
     *
     * @param \core_customfieldcategory\data_controller $data
     */
    public function __construct(\core_customfieldcategory\data_controller $data) {
        $this->data = $data;
    }
