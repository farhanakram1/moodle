...
namespace core_customfieldcategory\privacy;
...
class provider implements
    ...
    public static function export_customfields_data(approved_contextlist $contextlist, string $component, string $area,
        ...
        if ($subcontext === null) {
            $subcontext = [get_string('customfielddata', 'core_customfieldcategory')];
        }
    ...
    protected static function before_delete_fields(string $categoryidstest, array $params) {
        ...
        foreach ($contexts as $contextid) {
            get_file_storage()->delete_area_files_select($contextid, 'core_customfieldcategory', 'description',
                " IN ($fieldsql) ", $params);
        }
