...
namespace core_customfieldcategory\event;

use core_customfieldcategory\category_controller;
...
class category_created extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventcategorycreated', 'core_customfieldcategory');
    }
