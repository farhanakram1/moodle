...
use core_customfieldcategory\event\category_created;
use core_customfieldcategory\event\category_deleted;
use core_customfieldcategory\event\category_updated;
use core_customfieldcategory\event\field_created;
use core_customfieldcategory\event\field_deleted;
use core_customfieldcategory\event\field_updated;
...
class api {
    ...
    public static function save_field_configuration(field_controller $field, \stdClass $formdata) {
        ...
        if (isset($formdata->description_editor)) {
            ...
            $data = file_postupdate_standard_editor($data, 'description', $textoptions, $textoptions['context'],
                'core_customfieldcategory', 'description', $field->get('id'));
    ...
    public static function delete_field_configuration(field_controller $field) : bool {
        ...
        get_file_storage()->delete_area_files($field->get_handler()->get_configuration_context()->id, 'core_customfieldcategory',
    ...
    public static function get_category_inplace_editable(category_controller $category, bool $editable = true) : inplace_editable {
        return new inplace_editable('core_customfieldcategory',
                                    'category',
                                    $category->get('id'),
                                    $editable,
                                    $category->get_formatted_name(),
                                    $category->get('name'),
                                    get_string('editcategoryname', 'core_customfieldcategory'),
    ...
    public static function prepare_field_for_config_form(field_controller $field) : \stdClass {
        if ($field->get('id')) {
            ...
            $textoptions = $field->get_handler()->get_description_text_options();
            file_prepare_standard_editor($formdata, 'description', $textoptions, $textoptions['context'], 'core_customfieldcategory',
