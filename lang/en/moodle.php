...
$string['addnewcategory'] = 'Add new residency';
...
$string['addsubcategory'] = 'Add a residency subcategory';
...
$string['adminhelpcourses'] = 'Define courses and residencies and assign people to them, edit pending courses';
...
$string['allcategories'] = 'All residencies';
...
$string['categories'] = 'Course residencies';
$string['categoriesandcourses'] = 'Course residencies and courses';
$string['category'] = 'Residency';
$string['categoryadded'] = 'The residency  \'{$a}\' was added';
$string['categorybulkaction'] = 'Bulk actions for selected residencies';
$string['categorycontents'] = 'Residency subcategories and courses';
$string['categorycurrentcontents'] = 'Contents of {$a}';
$string['categorydeleted'] = 'The residency  \'{$a}\' was deleted';
$string['categoryduplicate'] = 'A residency  named \'{$a}\' already exists!';
$string['categoryhidden'] = '(hidden)';
$string['categorymodifiedcancel'] = 'Residency was modified! Please cancel and try again.';
$string['categoryname'] = 'Residency name';
$string['categorysubcategoryof'] = '{$a->category} - subcategory of {$a->parentcategory}';
$string['idnumbercoursecategory'] = 'Residency Code';
$string['idnumbercoursecategory_help'] = 'The ID number of a course residency  is only used when matching the residency  against external systems and is not displayed anywhere on the site. If the residency  has an official code name it may be entered, otherwise the field can be left blank.';
$string['categoryupdated'] = 'The residency  \'{$a}\' was updated';
...
$string['confirmcoursemove'] = 'Are you sure you want to move this course ({$a->course}) into this residency  ({$a->category})?';
...
$string['coursecategories'] = 'Course residencies';
$string['coursecategory'] = 'Course residency ';
$string['coursecategory_help'] = 'This setting determines the residency  in which the course will appear in the list of courses.';
$string['coursecategorydeleted'] = 'Deleted course residency  {$a}';
$string['coursecatmanagement'] = 'Course and residency  management';
...
$string['courseextendednamedisplay'] = '{$a->shortname}';
...
$string['createcategory'] = 'Create residency';
$string['createfolder'] = 'Create a folder in {$a}';
$string['createnew'] = 'Create new';
$string['createnewcategory'] = 'Create new residency';
$string['createnewcourse'] = 'Create new course';
$string['createnewsubcategory'] = 'Create new residency subcategory';
$string['createsubcategoryof'] = 'Create residency subcategory of {$a}';
...
$string['creatingcategoriesandquestions'] = 'Creating residencies and questions';
...
$string['deletecategory'] = 'Delete residency: {$a}';
$string['deletecategoryempty'] = 'This residency  is empty.';
$string['deletecategorycheck'] = 'Are you absolutely sure you want to completely delete this residency  <b>\'{$a}\'</b>?<br />This will move all courses into the parent residency if there is one, or into Miscellaneous.';
$string['deletecategorycheck2'] = 'If you delete this residency , you need to choose what to do with the courses and subcategories it contains.';
...
$string['dndcourse'] = 'You can drag and drop this course to alter its sorting or to move it to another residency .';
...
$string['dontsortcategories'] = 'Don\'t sort residencies';
...
$string['edit'] = 'Edit';
$string['edita'] = 'Edit {$a}';
$string['editcategorysettings'] = 'Edit residency  settings';
$string['editcategorythis'] = 'Edit this residency ';
...
$string['reemail'] = 'Re-Enter Your Email address';
...
$string['frontpagecategorynames'] = 'List of residencies';
...
$string['movecategoriessuccess'] = 'Successfully moved {$a->count} residencies into category \'{$a->to}\'';
$string['movecategorytotopsuccess'] = 'Successfully moved category \'{$a->moved}\' to top level';
$string['movecategoriestotopsuccess'] = 'Successfully moved {$a->count} residencies to top level';
...
$string['moveselectedcategoriesto'] = 'Move selected residencies to';
...
$string['parentcategory'] = 'Parent residency';
...
//$string['username'] = 'Username';
$string['usernameemail'] = 'Username or email address';
...
$string['usernameoremail'] = 'Enter username or email address';
...
$string['registeration_code_eodo'] = 'Registration code can be requested from EODO';
$string['one_time_payment']='<b>One-time</b> Subscription Payment';
$string['registrationcode'] = 'Registeration Code';
$string['cc_payment'] = 'Credit Card Number';
$string['cc_exp_date'] = 'Expiry Date';
$string['cc_cvv'] = 'CVV';
$string['cc_discount_code'] = 'Discount Code';
